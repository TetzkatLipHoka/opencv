...
# --- LEPTONICA (optional, should be searched after zlib and libjpeg) ---
if(WITH_LEPTONICA)
  ocv_clear_vars(LEPTONICA_LIBRARY LEPTONICA_LIBRARIES LEPTONICA_INCLUDE_DIR)

  set(LEPTONICA_LIBRARY leptonica CACHE INTERNAL "")
  set(LEPTONICA_LIBRARIES ${LEPTONICA_LIBRARY})
  add_subdirectory("${OpenCV_SOURCE_DIR}/3rdparty/LEPTONICA")
  set(LEPTONICA_INCLUDE_DIR "${${LEPTONICA_LIBRARY}_SOURCE_DIR}" "${${LEPTONICA_LIBRARY}_BINARY_DIR}" CACHE INTERNAL "")
  set(LEPTONICA_VERSION "1.84.0")

  set(HAVE_LEPTONICA YES)
endif()

# --- TESSERACT (optional, should be searched after zlib and libjpeg) ---
if(WITH_TESSERACT)
  ocv_clear_vars(TESSERACT_LIBRARY TESSERACT_LIBRARIES TESSERACT_INCLUDE_DIR)

  set(TESSERACT_LIBRARY libtesseract CACHE INTERNAL "")
  set(TESSERACT_LIBRARIES ${TESSERACT_LIBRARY})
  add_subdirectory("${OpenCV_SOURCE_DIR}/3rdparty/TESSERACT")
  set(TESSERACT_INCLUDE_DIR "${${TESSERACT_LIBRARY}_SOURCE_DIR}/include" "${${TESSERACT_LIBRARY}_BINARY_DIR}" CACHE INTERNAL "")
  set(TESSERACT_VERSION "5.3.3")

  set(HAVE_TESSERACT YES)
endif()
...
if(NOT BUILD_SHARED_LIBS)
  ocv_install_target(${TESSERACT_LIBRARY} EXPORT OpenCVModules ARCHIVE DESTINATION ${OPENCV_3P_LIB_INSTALL_PATH} COMPONENT dev)
endif()
